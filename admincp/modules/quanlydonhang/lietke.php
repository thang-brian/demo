    ...
    <tr>
      ...
      <td>
        <?php if($row['cart_status']==1 || $row['cart_status']==4){
          ?>
          <a data-toggle="tooltip" data-placement="right" title="Bạn muốn duyệt đơn hàng này?" onclick="return confirm('Bạn đã Xem Đơn Hàng trước khi duyệt và vẫn muốn duyệt đơn này?')" href="modules/quanlydonhang/xuly.php?code=<?php echo $row['code_cart']?>">Đơn hàng mới</a>
        <?php
